  ...
  return (
    <div>
      ...
      <div className="bg-surface border border-hair rounded-2xl p-8">
        <h1 className="text-2xl font-bold tracking-tight text-ink mb-1">Create an account</h1>
        <p className="text-[14px] text-ink2 mb-7">Your binder starts here. Free forever.</p>
